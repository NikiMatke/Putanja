...
CITIES = [
    ("S", 0.00, 0.00), ("T1", -.0713, .1235), ("T2", -.0784, .1040),
    ("T3", -.0950, .0327), ("T4", -.0797, .0084), ("T5", -.0793, -.0140),
    ("T6", -.0843, -.0708), ("T7", -.1030, -.1227), ("T8", -.0853, -.1477),
    ("T9", .1200, 0.00), ("T10", .0698, .0403), ("T11", .0617, .0518),
]
